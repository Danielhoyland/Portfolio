...
public class AddLinkDialog extends Dialog {
  ...
  private TextField requiresItemField;
  private TextField minHealthField;
  ...
  public AddLinkDialog(EditStoryController controller) {
    ...
    Label requiresItemLabel = new Label(resourceBundle.getString("label.requiresItem"));
    requiresItemField = new TextField();

    Label minHealthLabel = new Label(resourceBundle.getString("label.minHealth"));
    minHealthField = new TextField();

    Label minGoldLabel = new Label(resourceBundle.getString("label.minGold"));
    minGoldField = new TextField();

    Label minScoreLabel = new Label(resourceBundle.getString("label.minScore"));
    minScoreField = new TextField();

    gridPane.addRow(0, linkLabel);
    gridPane.addRow(1, linkTextField);
    gridPane.addRow(2, requiresItemLabel);
    gridPane.addRow(3, requiresItemField);
    gridPane.addRow(4, minHealthLabel);
    gridPane.addRow(5, minHealthField);
    gridPane.addRow(6, minGoldLabel);
    gridPane.addRow(7, minGoldField);
    gridPane.addRow(8, minScoreLabel);
    gridPane.addRow(9, minScoreField);
    gridPane.addRow(10, createTableView());

    HBox buttonBox = new HBox();
    buttonBox.setAlignment(javafx.geometry.Pos.CENTER);
    buttonBox.setSpacing(10);
    buttonBox.getChildren().addAll(addButton, cancelButton);
    gridPane.addRow(11, buttonBox);
  ...
  public String getRequiresItem() { return requiresItemField.getText(); }
  public String getMinHealthText() { return minHealthField.getText(); }
  public String getMinGoldText() { return minGoldField.getText(); }
  public String getMinScoreText() { return minScoreField.getText(); }

  public void setRequiresItem(String v) { requiresItemField.setText(v); }
  public void setMinHealth(Integer v) { minHealthField.setText(v == null ? "" : String.valueOf(v)); }
  public void setMinGold(Integer v) { minGoldField.setText(v == null ? "" : String.valueOf(v)); }
  public void setMinScore(Integer v) { minScoreField.setText(v == null ? "" : String.valueOf(v)); }
}
