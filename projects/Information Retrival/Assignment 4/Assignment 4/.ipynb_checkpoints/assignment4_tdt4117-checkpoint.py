...
def rag_answer(query: str, k: int = 5) -> str:
    """
    RAG pipeline: retrieves top-k posts, builds context, and generates a detailed answer.
    """
    ...
    prompt = (
        ...
        "Write a complete, coherent, and detailed response in full sentences.\n\n"
        f"Context:\n{context}\n\n"
        f"Question: {query}\n"
        "Answer:"
    )
    ...
    return gen_tokenizer.decode(result[0], skip_special_tokens=True).strip()
